...
# https://stackoverflow.com/a/53865194/17002774
import os
c.FileCheckpoints.checkpoint_dir = os.environ['TMPDIR']
...
#  Choices: any of ['sha3_384', 'md5', 'sha3_512', 'sha1', 'sha224', 'blake2s', 'sha3_256', 'blake2b', 'sha3_224', 'sha256', 'sha512', 'sha384']
#  Default: 'sha256'

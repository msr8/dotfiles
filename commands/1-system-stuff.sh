...
# DWM
sudo dnf -y install git xsetroot make gcc libX11-devel libXft-devel libXinerama-devel imlib2 imlib2-devel #imlib2 and imlib2-devel for the winicon patch
mkdir ~/repos
cd ~/repos

...
positionOptions =
  ...
  paddingPercentageX: '-2%'  # Padding percentage applied to the X axis [value + '%']
  paddingPercentageY: '0%'  # Padding percentage applied to the Y axis [value + '%']

backgroundOptions =
  color: 'black'            # Background color [HEX code or css predefined color (i.e red, white, black, blue)]
  opacity: 0              # Background opacity [between 0 and 1]
  rounded: true             # Background rounded or squared [true or false]

textOptions =
  color: 'gray'            # Text color [HEX code or css predefined color (i.e red, white, black, blue)]
  opacity: 1                # Text opacity [between 0 and 1]

borderOptions =
  enable: false            # Show/hide background border [true, false]
